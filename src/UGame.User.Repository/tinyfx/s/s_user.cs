...
namespace UGame.User.Repository
{
	...
	public class S_userMO : MySqlTableMO<S_userEO>
	{
		...
		{
			sql_ = $"UPDATE {TableName} SET `UserID` = @UserID, `UserMode` = @UserMode, `OAuthType` = @OAuthType, `OAuthID` = @OAuthID, `Nickname` = @Nickname, `FromMode` = @FromMode, `FromId` = @FromId, `OperatorID` = @OperatorID, `OperatorUserId` = @OperatorUserId, `CountryID` = @CountryID, `CurrencyID` = @CurrencyID, `Cash` = @Cash, `Bonus` = @Bonus, `Coin` = @Coin, `Gold` = @Gold, `SWB` = @SWB, `Point` = @Point, `VIP` = @VIP, `PUserID1` = @PUserID1, `PUserID2` = @PUserID2, `UserProfile` = @UserProfile, `UserKind` = @UserKind, `IMEI` = @IMEI, `GAID` = @GAID, `UserIp` = @UserIp, `ClientUrl` = @ClientUrl, `DomainID` = @DomainID, `ThemesID` = @ThemesID, `Status` = @Status, `RegistDate` = @RegistDate, `Mobile` = @Mobile, `Email` = @Email, `Username` = @Username, `Password` = @Password, `PasswordSalt` = @PasswordSalt, `HasBet` = @HasBet, `HasPay` = @HasPay, `HasCash` = @HasCash WHERE `UserID` = @UserID_Original";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", item.UserID, MySqlDbType.VarChar),
				Database.CreateInParameter("@UserMode", item.UserMode, MySqlDbType.Int32),
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int PutDomainIDByPK(string userID, string domainID, TransactionManager tm_ = null)
		{
			RepairPutDomainIDByPKData(userID, domainID, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutDomainIDByPKAsync(string userID, string domainID, TransactionManager tm_ = null)
		{
			RepairPutDomainIDByPKData(userID, domainID, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutDomainIDByPKData(string userID, string domainID, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `DomainID` = @DomainID  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public string GetDomainIDByPK(string userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.VarChar),
			};
			return (string)GetScalar("`DomainID`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<string> GetDomainIDByPKAsync(string userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.VarChar),
			};
			return (string)await GetScalarAsync("`DomainID`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// /// <param name = "domainID">域名（不带http）</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID)
		{
			return GetByDomainID(domainID, 0, string.Empty, null);
		}
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID, TransactionManager tm_)
		{
			return GetByDomainID(domainID, 0, string.Empty, tm_);
		}
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID, int top_)
		{
			return GetByDomainID(domainID, top_, string.Empty, null);
		}
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID, int top_, TransactionManager tm_)
		{
			return GetByDomainID(domainID, top_, string.Empty, tm_);
		}
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID, string sort_)
		{
			return GetByDomainID(domainID, 0, sort_, null);
		}
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID, string sort_, TransactionManager tm_)
		{
			return GetByDomainID(domainID, 0, sort_, tm_);
		}
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<S_userEO> GetByDomainID(string domainID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<S_userEO>> GetByDomainIDAsync(string domainID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL(domainID != null ? "`DomainID` = @DomainID" : "`DomainID` IS NULL", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			if (domainID != null)
